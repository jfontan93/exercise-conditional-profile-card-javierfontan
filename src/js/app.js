          ...
          <ul ${
            ...
            <li>${
              variables.twitter == null
                ? `<a href="https://twitter.com/4geeksacademy"><i class="fab fa-twitter"></i></a>`
            ...
            <li>${
              variables.linkedin == null
                ? `<a href="https://linkedin.com/school/4geeksacademy"><i class="fab fa-linkedin"></i></a>`
                : `<a href="https://twitter.com/${variables.linkedin}"><i class="fab fa-linkedin"></i></a>`
            }</li>

            <li>${
              variables.instagram == null
                ? `<a href="https://instagram.com/4geeksacademy"><i class="fab fa-instagram"></i></a>`
                : `<a href="https://twitter.com/${variables.instagram}"><i class="fab fa-instagram"></i></a>`
            }</li>
